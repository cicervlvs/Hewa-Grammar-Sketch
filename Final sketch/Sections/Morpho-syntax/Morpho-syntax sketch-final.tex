...
\endgl
\xe %i missed the possessive suffix and the pronoun!
...
Verbs in Hewa are not inflected by tense, so the time at which an action takes place is expressed syntactically. %with words? might be ambiguous
...
%negation might be also used for nouns and adjectives
...
%Might be analyzable into two lexical words, also -n in upan might be a possessive?
